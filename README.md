...
- Une branche par groupe : `feat/groupe-N-nom-du-poste`
- Un fichier par personne dans `postes/`
- Une seule ligne ajoutée au tableau ci-dessus, par groupe
- Toute modification passe par une pull request approuvée
